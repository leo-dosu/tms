          ...
          <div className="image__width--text__thumbnail position-relative">
            ...
            <div className="image__width--text">
              ...
              <div className="image__width--text__footer">
                <a className="image__width--text__link" href="shop.html">Shop Now 
                ...
                <a className="image__width--text__link glightbox" href="https://vimeo.com/115041822" data-gallery="video">Play Video 
      ...
      <div className="container">
        ...
        <div className="product__section--inner">
              ...
              <article className="product__card">
                <div className="product__card--thumbnail">
                  ...
                  <ul className="product__card--action">
                    ...
                    <li className="product__card--action__list">
                      <a className="product__card--action__btn" title="Compare" href="#">
            ...
            <div className="col-lg-3 col-md-4 col-sm-6 col-6 custom-col mb-30">
              <article className="product__card">
                ...
                <div className="product__card--content text-center">
                  ...
                  <h3 className="product__card--title"><a href="product-details.html">Z 7-8mm Freshw Button Pearl </a></h3>
                  <div className="product__card--price">
                    <span className="current__price">$239.52</span>
                    <span className="old__price"> $362.00</span>
                  </div>  
            ...
            <div className="col-lg-3 col-md-4 col-sm-6 col-6 custom-col mb-30">
              <article className="product__card">
                ...
                <div className="product__card--content text-center">
                  ...
                  <h3 className="product__card--title"><a href="product-details.html">Sed impedit autem min ver velit?</a></h3>
                  <div className="product__card--price">
                    <span className="current__price">$220.52</span>
                    <span className="old__price"> $330.00</span>
                  </div>  
                </div>
              </article>
            </div>
            <div className="col-lg-3 col-md-4 col-sm-6 col-6 custom-col mb-30">
              <article className="product__card">
                ...
                <div className="product__card--content text-center">
                  ...
                  <h3 className="product__card--title"><a href="product-details.html">Alias facilis ut natus  beatae. </a></h3>
                  <div className="product__card--price">
                    <span className="current__price">$239.52</span>
                    <span className="old__price"> $362.00</span>
                  </div>  
          ...
          <div className="product__load--more text-center">
            <a className="load__more--btn primary__btn" href="shop.html">Load More</a>
          </div>
        </div>
      </div>
    </section>
        ...
        <div className="container">
          <div className="video__banner--inner d-flex align-items-end">
            ...
            <div className="video__banner--content">
              ...
              <a className="video__banner--content__btn primary__btn" href="shop.html">SKINCARE</a>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="row align-items-center">
            ...
            <div className="col-lg-6 col-md-6">
              <div className="banner__fullwidth--content">
                ...
                <a className="banner__fullwidth--content__btn primary__btn" href="index.html#">SHOP NOW</a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="row mb--n30">
          <div className="col-lg-6 col-md-6 mb-30">
            <div className="banner__box border-radius-5 position-relative">
              <a className="display-block" href="shop.html"><img className="banner__box--thumbnail border-radius-5" src="assets/img/banner/banner7.webp" alt="banner-img" />
          ...
          <div className="col-lg-6 col-md-6 mb-30">
            <div className="banner__box border-radius-5 position-relative">
              <a className="display-block" href="shop.html"><img className="banner__box--thumbnail border-radius-5" src="assets/img/banner/banner8.webp" alt="banner-img" />
                <div className="banner__box--content">
