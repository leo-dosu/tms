              ...
              <div className="shop__sidebar--product">
                <div className="small__product--card d-flex">
                  <div className="small__product--thumbnail">
                    <a className="display-block" href="product-details.html"><img src="assets/img/product/small-product/product1.webp" alt="product-img" /></a>
                  </div>
                  <div className="small__product--content">
                    <h3 className="small__product--card__title"><a href="product-details.html">White Cream </a></h3>
                ...
                <div className="small__product--card d-flex">
                  <div className="small__product--thumbnail">
                    <a className="display-block" href="product-details.html"><img src="assets/img/product/small-product/product2.webp" alt="product-img" /></a>
                  </div>
                  <div className="small__product--content">
                    <h3 className="small__product--card__title"><a href="product-details.html">Sneaky lips </a></h3>
                    <div className="small__product--card__price mb_5">
                ...
                <div className="small__product--card d-flex">
                  <div className="small__product--thumbnail">
                    <a className="display-block" href="product-details.html"><img src="assets/img/product/small-product/product3.webp" alt="product-img" /></a>
                  </div>
                  <div className="small__product--content">
