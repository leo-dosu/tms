const Whitelist = () => {
        ...
        <div className="col">
          <div className="breadcrumb__content text-center">
            <ul className="breadcrumb__content--menu d-flex justify-content-center">
              ...
              <li className="breadcrumb__content--menu__items"><span>Wishlist</span></li>
            </ul>
          </div>
        </div>
      </div>
                  ...
                  <td className="cart__table--body__list">
                    <div className="cart__product d-flex align-items-center">
                      ...
                      <div className="cart__thumbnail">
                        <a href="product-details.html"><img className="border-radius-5" src="assets/img/product/small-product/product1.webp" alt="cart-product" /></a>
                      </div>
                      <div className="cart__content">
                        <h3 className="cart__content--title h4"><a href="product-details.html">Fairness cream</a></h3>
                ...
                <tr className="cart__table--body__items">
                  <td className="cart__table--body__list">
                    <div className="cart__product d-flex align-items-center">
                      ...
                      <div className="cart__thumbnail">
                        <a href="product-details.html"><img className="border-radius-5" src="assets/img/product/small-product/product2.webp" alt="cart-product" /></a>
                      </div>
                      <div className="cart__content">
                        <h3 className="cart__content--title h4"><a href="product-details.html">Matte Walnut</a></h3>
                        <span className="cart__content--variant">COLOR: Blue</span>
                        <span className="cart__content--variant">WEIGHT: 2 Kg</span>
                      </div>
                    </div>
                ...
                <tr className="cart__table--body__items">
                  <td className="cart__table--body__list">
                    <div className="cart__product d-flex align-items-center">
                      ...
                      <div className="cart__thumbnail">
                        <a href="product-details.html"><img className="border-radius-5" src="assets/img/product/small-product/product3.webp" alt="cart-product" /></a>
                      </div>
                      <div className="cart__content">
                        <h3 className="cart__content--title h4"><a href="product-details.html">Freshw Button</a></h3>
                        <span className="cart__content--variant">COLOR: Blue</span>
                        <span className="cart__content--variant">WEIGHT: 2 Kg</span>
                      </div>
                    </div>
                ...
                <tr className="cart__table--body__items">
                  <td className="cart__table--body__list">
                    <div className="cart__product d-flex align-items-center">
                      ...
                      <div className="cart__thumbnail">
                        <a href="product-details.html"><img className="border-radius-5" src="assets/img/product/small-product/product4.webp" alt="cart-product" /></a>
                      </div>
                      <div className="cart__content">
                        <h3 className="cart__content--title h4"><a href="product-details.html">White Cream</a></h3>
                        <span className="cart__content--variant">COLOR: Blue</span>
                        <span className="cart__content--variant">WEIGHT: 2 Kg</span>
                      </div>
                    </div>
  ...
  {/* End product section */}
  {/* Start brand section */}
  <div className="brand__section brand__section-two section--padding pt-0">
    <div className="container">
      <div className="brand__section--inner brand__logo--activation swiper">
        <div className="swiper-wrapper">
          <div className="swiper-slide">
            <div className="brang__logo--items">
              <img className="brang__logo--img" src="assets/img/logo/brand-logo1.webp" alt="brand-logo" />
            </div>
          </div>
          <div className="swiper-slide">
            <div className="brang__logo--items">
              <img className="brang__logo--img" src="assets/img/logo/brand-logo2.webp" alt="brand-logo" />
            </div>
          </div>
          <div className="swiper-slide">
            <div className="brang__logo--items">
              <img className="brang__logo--img" src="assets/img/logo/brand-logo3.webp" alt="brand-logo" />
            </div>
          </div>
          <div className="swiper-slide">
            <div className="brang__logo--items">
              <img className="brang__logo--img" src="assets/img/logo/brand-logo4.webp" alt="brand-logo" />
            </div>
          </div>
          <div className="swiper-slide">
            <div className="brang__logo--items">
              <img className="brang__logo--img" src="assets/img/logo/brand-logo5.webp" alt="brand-logo" />
            </div>
          </div>
          <div className="swiper-slide">
            <div className="brang__logo--items">
              <img className="brang__logo--img" src="assets/img/logo/brand-logo6.webp" alt="brand-logo" />
            </div>
          </div>
          <div className="swiper-slide">
            <div className="brang__logo--items">
              <img className="brang__logo--img" src="assets/img/logo/brand-logo7.webp" alt="brand-logo" />
            </div>
          </div>
        </div>
        <div className="swiper__nav--btn swiper-button-next">
