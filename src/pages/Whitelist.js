              ...
              <tbody className="cart__table--body">
                <tr className="cart__table--body__items">
                  <td className="cart__table--body__list">
                    <div className="cart__product d-flex align-items-center">
                      ...
                      <div className="cart__thumbnail">
                        <Link to="/productDetail"><img className="border-radius-5" src="assets/img/product/small-product/product1.webp" alt="cart-product" /></Link>
                      </div>
                      <div className="cart__content">
                        <h3 className="cart__content--title h4"><Link to="/productDetail">Fairness cream</Link></h3>
                  ...
                  <td className="cart__table--body__list text-right">
                    <Link className="wishlist__cart--btn primary__btn" to="/cart">Add To Cart</Link>
                  </td>
                </tr>
                <tr className="cart__table--body__items">
                  <td className="cart__table--body__list">
            ...
            <article className="product__card">
              <div className="product__card--thumbnail">
                ...
                <div className="product__add--to__card">
                  <Link className="product__card--btn" title="Add To Card" to="/cart"> Add to Cart
